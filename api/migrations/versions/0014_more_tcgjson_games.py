"""Allow five additional tcgjson card games and decks."""

from alembic import op

revision = "0014_more_tcgjson_games"
down_revision = "0013_one_piece_catalog"
branch_labels = None
depends_on = None

OLD_GAME_CHECK = "game IN ('mtg', 'pokemon', 'yugioh', 'onepiece')"
NEW_GAME_CHECK = (
