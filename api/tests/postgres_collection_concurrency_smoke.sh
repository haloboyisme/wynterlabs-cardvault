...
suffix="${$}-${RANDOM}"
network_name="wynterlabs-collection-concurrency-${suffix}"
database_container="wynterlabs-collection-concurrency-pg-${suffix}"
database_user="collection_concurrency"
database_name="collection_concurrency"
database_password="test-only-credential-cc6ffde8399f"
