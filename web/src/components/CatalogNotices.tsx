  ...
  return (
    <aside className="catalog-notices" aria-label="Card data and fan content notices">
      {shownGames.has("mtg") && <>
        ...
        <p>WynterLabs Cards is unofficial fan content permitted under the <a href="https://company.wizards.com/en/legal/fancontentpolicy" target="_blank" rel="noreferrer">Wizards Fan Content Policy</a>. It is not approved or endorsed by Wizards of the Coast.</p>
