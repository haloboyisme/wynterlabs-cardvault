  ...
  return (
    <section className="invitation-accept-page">
      <div className="invitation-accept-card">
        <p className="eyebrow">Private WynterLabs membership</p>
        ...
        {complete ? (
          ...
          <form onSubmit={(event) => void submit(event)}>
            <p>Choose your own credentials. The private link can be used only once.</p>
            ...
            <button type="submit" disabled={busy || available !== true}>{busy ? "Creating account" : "Accept invitation"}</button>
          </form>
        )}
